...
ggplot(d2p1,aes(prop_health_insurance,youth_pov_prop_est)) + geom_point( aes(col=State_abb)) + geom_smooth(method = lm, se= FALSE) + geom_text(aes(label = State_abb)) + theme(legend.position = "none") + xlab("Percentage of the Population With Health Insurance") + ylab("Youth Poverty Rate")
```
