...
summary(d2pbai$youth_pov_prop_est)
sd(d2pbai$youth_pov_prop_est)
sd(d2pbai$youth_pov_prop_est)/15.93
...
summary(d2pbai$prop_health_insurance)
sd(d2pbai$prop_health_insurance)
sd(d2pbai$prop_health_insurance)/89.17
...
ggplot(d2pbai,aes(prop_health_insurance,youth_pov_prop_est)) + geom_point( aes(col=State_abb)) + geom_smooth(method = lm, se= FALSE) + geom_text(aes(label = State_abb)) + theme(legend.position = "none")
